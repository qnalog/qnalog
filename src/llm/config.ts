...
export const LLM_SERVICE_PRESETS = [
  {
    ...
    endpointHelp: "硅基流动的大模型对话接口地址。通常保持默认即可；QnALog 会按 Chat Completions 请求发送。",
  ...
  },
  {
    ...
    endpointHelp: "OpenAI 官方 API Base URL。填写到 /v1 即可，QnALog 会自动补全 /chat/completions。",
  ...
  },
  {
    ...
    endpointHelp: "OpenRouter 的 OpenAI 兼容 API Base URL。QnALog 会自动附加 OpenRouter 建议的应用识别请求头。",
  ...
  },
  {
    ...
    endpointHelp: "Moonshot / Kimi 的 API Base URL。填写到 /v1 即可，QnALog 会自动补全 /chat/completions。",
  ...
  },
  {
    ...
    endpointHelp: "DeepSeek API Base URL。填写根地址即可，QnALog 会自动补全 /chat/completions。",
  ...
  },
  {
    ...
    endpointHelp: "小米 MiMo 的 OpenAI 兼容 API Base URL，填到 /v1 即可，QnALog 会自动补全 /chat/completions。与 MiMo 语音转写共用同一个地址和密钥。",
  ...
  },
  {
    ...
    endpointHelp: "Perplexity API Base URL。填写根地址即可，QnALog 会自动补全 /chat/completions。",
